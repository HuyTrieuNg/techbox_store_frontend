...
const CartItem: React.FC<Props> = ({ item }) => {
  ...
  return (
    <div className="grid grid-cols-[2fr_2fr_1fr_2fr] items-center py-4 px-6 border-b border-gray-200 hover:bg-gray-50 transition">
      {/* Cột sản phẩm */}
      <div className="flex items-center space-x-3">
        <button
          onClick={handleRemove}
          className="text-gray-500 hover:text-[#E61E4D] text-2xl cursor-pointer select-none"
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 line-clamp-2">{item.variantName}</p>
        </div>
      </div>
      ...
      ${item.quantity <= 1
              ...
              : "border-gray-400 text-gray-700 hover:bg-gray-200 active:scale-95 cursor-pointer"
            }
    `}
